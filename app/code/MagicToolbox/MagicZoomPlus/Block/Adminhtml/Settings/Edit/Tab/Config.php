...
use MagicToolbox\MagicZoomPlus\Helper\UpgradeData;
...
class Config extends \Magento\Backend\Block\Widget\Form\Generic
{
     ...
     * Upgrade data helper
     *
     * @var \MagicToolbox\MagicZoomPlus\Helper\UpgradeData
     */
     ...
     * @param \MagicToolbox\MagicZoomPlus\Helper\UpgradeData $upgradeDataHelper
     * @param array $data
     */
    public function __construct(
        ...
        \MagicToolbox\MagicZoomPlus\Helper\UpgradeData $upgradeDataHelper,
        array $data = []
    ) {
    ...
    protected function _prepareLayout()
    {
        ...
        if (is_null($fieldsetElementRenderer)) {
            $fieldsetElementRenderer = $this->getLayout()->createBlock(
                'MagicToolbox\MagicZoomPlus\Block\Adminhtml\Settings\Edit\Form\Renderer\Fieldset\Element',
