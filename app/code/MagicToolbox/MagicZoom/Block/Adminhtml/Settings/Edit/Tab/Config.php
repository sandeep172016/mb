...
use MagicToolbox\MagicZoom\Helper\UpgradeData;
...
class Config extends \Magento\Backend\Block\Widget\Form\Generic
{
     ...
     * Upgrade data helper
     *
     * @var \MagicToolbox\MagicZoom\Helper\UpgradeData
     */
     ...
     * @param \MagicToolbox\MagicZoom\Helper\UpgradeData $upgradeDataHelper
     * @param array $data
     */
    public function __construct(
        ...
        \MagicToolbox\MagicZoom\Helper\UpgradeData $upgradeDataHelper,
        array $data = []
    ) {
